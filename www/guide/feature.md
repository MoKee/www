...
### 支持显示农历、节气、法定节假日与调休 <Badge text="MK71.2+" />
...
### ics 格式文件导入导出 <Badge text="MK71.2+" />

您可以自行制作和下载 ics 格式的日历数据文件并将其导入到日历中，例如导入"2018年的欧冠赛程"。

![ics 格式文件导入导出](/screenshots/zh/calendar/calendar_ics.png)

### CalDAV 协议同步 <Badge text="MK71.2+" />

借助 CalDAV 协议，您可以与支持该协议的其它软件同步数据，例如与 Google 日历同步数据。
